...
export const GalleryNav = () => {
  ...
  const [addedPhoto, setAddedPhoto] = useState<Photo | null>(null);
  const photos: Photo[] = [
    {
      id: 124,
      ...
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/23.01+Bryce+Pano+5MB.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/23.01+Bryce+Pano-small.jpg",
    ...
    },
    {
      ...
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_5862.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_5862-small.jpg",
    ...
    },
    {
      ...
      location: "Moab, Utah",
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/12.09+Moab-239-Edit+4x6+5MB.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/12.09+Moab-239-Edit+4x6+small.jpg",
    ...
    },
    {
      ...
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/16.11+Zion-445-Pano+3x1+5MB.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/16.11+Zion-445-Pano+3x1-small.jpg",
    ...
    },
    {
      ...
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/20.03+St+George-177+2x1+4MB.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/20.03+St+George-177+2x1-small.jpg",
    ...
    },
    {
      ...
      location: "Moab, Utah",
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/12.09+Moab-120-Edit+4x6+5MB.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/12.09+Moab-120-Edit+4x6-smallsh.jpg",
    ...
    },
    {
      ...
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/20.07+Powell-357+4x6+5MB.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/20.07+Powell-357+4x6-small.jpg",
    ...
    },
    {
      ...
      location: "South Carolina",
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_7099-2.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_7099-2-small.jpg",
    ...
    },
    {
      ...
      location: "South Carolina",
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_6972.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_6972-small.jpg",
    ...
    // },
    {
      ...
      location: "South Carolina",
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_5832.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_5832-small.jpg",
    ...
    },
    {
      ...
      location: "South Carolina",
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_7026.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_7026-small.jpg",
    ...
    },
    {
      ...
      location: "South Carolina",
      mediumImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_5275.jpg",
      smallImage:
        "https://xolitude-photos.s3.us-west-2.amazonaws.com/SZ6_5275-small.jpg",
  ...
  const handleAddToCart = (photo: Photo, e: React.MouseEvent) => {
    e.stopPropagation();
    addToCart(photo);
    setAddedPhoto(photo);
    setShowToast(true);
  ...
  return (
    <GalleryContainer>
      <Row className="g-0 image-row">
        {photos.map((photo) => (
          <Col md={photo.width} key={photo.id}>
      ...
      <ToastComponent
        ...
        title="Success!"
        message={`${addedPhoto?.title} has been added to your cart.`}
      />
    </GalleryContainer>
  );
};
...
const GalleryContainer = styled.div`
  ...
  h2 {
    font-family: "Abhaya Libre", "Tenor Sans", "Quicksand", Verdana, Geneva,
      Tahoma, sans-serif;
    font-size: 50px;
    color: #254352;
    text-align: left;
  ...
  .photo-title {
    ...
    .add-cart-button {
      ...
      /* Show icon and hide text on mobile */
